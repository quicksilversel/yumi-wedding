...
export const Logo = forwardRef<SVGSVGElement, Props>((props, ref) => {
  return (
    ...
    >
      ...
      <Celebration className="wedding celebration">
        <path
          className="cls-1"
...
const weddingCelebration = keyframes`
  0% {
    clip-path: inset(0 100% 0 0);
...
const Wedding = styled.g`
  animation: ${weddingCelebration} 1s 1s both;
`

const Celebration = styled.g`
  animation: ${celebrationAnimation} 1s 1s both;
`

const Kota = styled.g`
  animation: ${weddingCelebration} 1s 0.5s both;
`

const Yumi = styled.g`
  animation: ${celebrationAnimation} 1s 0.5s both;
`
